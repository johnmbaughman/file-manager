...
namespace FileManager
{
    ...
    {
        [STAThread]
        static void Orig_Main(string[] args)
        {
            try
            {
                string settings;
            ...
            while (true)
            {
                ...
                GUI_Orig.DrawMenu(manager.FileManagerName);
                GUI_Orig.DrawName();
                GUI_Orig.DrawBottomPanel();
                ...
                while (!FullRestart)
                {
                    GUI_Orig.DrawPathes(manager.Esection, manager.LPath, manager.RPath);
                                            ...
                                            case 3:
                                                {
                                                    ...
                                                    try
                                                    {
                                                        ...
                                                        //    }
                                                        //}
                                                        throw new NotImplementedException("Doc viewer not ready");
                                                    }
                                                    catch (Exception) { break; }
